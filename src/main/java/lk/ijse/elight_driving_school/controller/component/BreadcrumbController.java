package lk.ijse.elight_driving_school.controller.component;
...
public class BreadcrumbController implements Initializable {
    ...
    public void init(Runnable run, String title) {
        ...
        if (run != null) {
            Image image = new Image(BreadcrumbController.class.getResource("/images/icons/arrow-right.png").toExternalForm());
